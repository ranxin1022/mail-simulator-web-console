package com.ericsson.jigsaw.simulator.mail.web.control.mail.receive;
...
import com.ericsson.jigsaw.simulator.mail.web.util.MailSession;
...
public class ReceiveMail {
	...
	private void connection(User user) throws MessagingException {
		...
		session = MailSession
				.getInstance("com/ericsson/jigsaw/simulator/mail/web/util/email.properties");
